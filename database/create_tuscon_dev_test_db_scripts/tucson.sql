...
==========================================================================================
ROLE tucson <== already there, DO NOT CREATE

DATABASE tucson  <== already there, DO NOT CREATE

SCHEMA tucson  <== need to create this 
==========================================================================================
...
CREATE SEQUENCE tucson.dxct_grp_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_grp_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.dxct_grp
(
    dxct_grp_id numeric(1,0) DEFAULT NEXTVAL('tucson.dxct_grp_id_seq') NOT NULL,
...
ALTER TABLE tucson.dxct_grp
    OWNER TO tucson;

------------------------------------------------------------------------------

CREATE SEQUENCE tucson.dxct_org_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_org_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.DXCT_ORG
(
DXCT_ORG_ID	numeric(1,0)  DEFAULT NEXTVAL('tucson.dxct_org_id_seq') NOT NULL,
...
ALTER TABLE tucson.DXCT_ORG
    OWNER TO tucson;

------------------------------------------------------------------------------
CREATE SEQUENCE tucson.dxct_aud_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_aud_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.DXCT_AUD
(
	DXCT_AUD_ID	INTEGER DEFAULT NEXTVAL('tucson.dxct_org_id_seq') NOT NULL,
	DXCT_AUD_UID	numeric(2,0) 	not null,
...
ALTER TABLE tucson.dxct_aud
    OWNER TO tucson;

------------------------------------------------------------------------------

CREATE SEQUENCE tucson.dxct_usr_type_id_seq
    INCREMENT 1
    START 1;
	
ALTER SEQUENCE tucson.dxct_usr_type_id_seq
    OWNER TO tucson;
	
CREATE TABLE tucson.dxct_usr_type
(
    dxct_usr_type_id numeric(1,0)  DEFAULT NEXTVAL('tucson.dxct_usr_type_id_seq') NOT NULL,
...
ALTER TABLE tucson.dxct_usr_type
    OWNER TO tucson;
	
------------------------------------------------------------------------------

CREATE SEQUENCE tucson.dxct_rack_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_rack_id_seq
    OWNER TO tucson;
	
CREATE TABLE tucson.dxct_rack
(
    dxct_rack_id INTEGER DEFAULT NEXTVAL('tucson.dxct_rack_id_seq') NOT NULL,
...
ALTER TABLE tucson.dxct_rack
    OWNER TO tucson;
------------------------------------------------------------------------------

CREATE SEQUENCE tucson.dxct_usr_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_usr_id_seq
    OWNER TO tucson;


CREATE TABLE tucson.dxct_usr
(
    dxct_usr_id integer NOT NULL DEFAULT nextval('tucson.dxct_usr_id_seq'),
...
ALTER TABLE tucson.dxct_usr
    OWNER to tucson;
------------------------------------------------------------------------------

DROP SEQUENCE TUCSON.dxct_rack_id_seq;
...
DROP TABLE TUCSON.DXCT_RACK;

CREATE TABLE TUCSON.DXCT_RACK
(
    dxct_rack_id integer NOT NULL DEFAULT nextval('TUCSON.dxct_rack_id_seq'),
    dxct_rack_name varchar(30) NOT NULL,
    dxct_rack_desc varchar(100) NOT NULL,
    CONSTRAINT dxct_rack_pkey PRIMARY KEY (dxct_rack_id, dxct_rack_name)
)

ALTER TABLE TUCSON.DXCT_RACK ADD CONSTRAINT DXCT_RACK_UC1 UNIQUE (DXCT_RACK_ID);
...
CREATE SEQUENCE tucson.dxct_gin_acq_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_gin_acq_id_seq
    OWNER TO tucson;

								
CREATE TABLE tucson.dxct_gin_acq
(
    ...
    dxct_gin_acq_id INTEGER DEFAULT NEXTVAL('tucson.dxct_gin_acq_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_acq_pkey PRIMARY KEY (dxct_gin_acq_lid, dxct_gin_acq_rnum)
)


ALTER TABLE tucson.DXCT_GIN_ACQ
    OWNER TO tucson;

---------------------------------------------------------------------------------

CREATE SEQUENCE tucson.dxct_gin_str_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_gin_str_id_seq
    OWNER TO tucson;

								
CREATE TABLE tucson.dxct_gin_str
(
	...
	DXCT_GIN_STR_ID INTEGER DEFAULT NEXTVAL('tucson.dxct_gin_str_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_str_pkey PRIMARY KEY (DXCT_GIN_STR_rnum, DXCT_GIN_STR_pnum,DXCT_GIN_STR_lid)
)


ALTER TABLE tucson.DXCT_GIN_STR
    OWNER TO tucson;

---------------------------------------------------------------------------------

CREATE SEQUENCE tucson.dxct_gin_str_rej_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.dxct_gin_str_rej_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.dxct_gin_str_REJ
(
	...
	DXCT_GIN_STR_REJ_ID INTEGER DEFAULT NEXTVAL('tucson.dxct_gin_str_rej_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_str_rej_pkey PRIMARY KEY (DXCT_GIN_STR_REJ_rnum, DXCT_GIN_STR_REJ_pnum,DXCT_GIN_STR_REJ_lid)
)

ALTER TABLE tucson.DXCT_GIN_STR_REJ
    OWNER TO tucson;

---------------------------------------------------------------------------------


CREATE SEQUENCE tucson.DXCT_GIN_INSTALL_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_GIN_INSTALL_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.DXCT_GIN_INSTALL
(
	...
	DXCT_GIN_INSTALL_ID INTEGER DEFAULT NEXTVAL('tucson.DXCT_GIN_INSTALL_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_install_pkey PRIMARY KEY (DXCT_GIN_INSTALL_rnum, DXCT_GIN_INSTALL_pnum,DXCT_GIN_INSTALL_lid)
)

ALTER TABLE tucson.DXCT_GIN_INSTALL
    OWNER TO tucson;

---------------------------------------------------------------------------------


CREATE SEQUENCE tucson.DXCT_GIN_OEM_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_GIN_OEM_id_seq
    OWNER TO tucson;
    
CREATE TABLE tucson.DXCT_GIN_OEM
(
	...
	DXCT_GIN_OEM_ID INTEGER DEFAULT NEXTVAL('tucson.DXCT_GIN_OEM_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_oem_pkey PRIMARY KEY (DXCT_GIN_OEM_rnum, DXCT_GIN_OEM_pnum,DXCT_GIN_OEM_lid)
)


ALTER TABLE tucson.DXCT_GIN_OEM
    OWNER TO tucson;
...
CREATE SEQUENCE tucson.DXCT_GIN_SUPP_MAINT_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_GIN_SUPP_MAINT_id_seq
    OWNER TO tucson;
    
CREATE TABLE tucson.DXCT_GIN_SUPP_MAINT
(
	...
	DXCT_GIN_SUPP_MAINT_ID INTEGER DEFAULT NEXTVAL('tucson.DXCT_GIN_SUPP_MAINT_id_seq') NOT NULL,
...
ALTER TABLE tucson.DXCT_GIN_SUPP_MAINT
    OWNER TO tucson;


---------------------------------------------------------------------------------

CREATE SEQUENCE tucson.DXCT_GIN_AST_MGMT_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_GIN_AST_MGMT_id_seq
    OWNER TO tucson;
    
CREATE TABLE tucson.DXCT_GIN_AST_MGMT
(
	...
	DXCT_GIN_AST_MGMT_ID INTEGER DEFAULT NEXTVAL('tucson.DXCT_GIN_AST_MGMT_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_ast_mgmt_pkey PRIMARY KEY (DXCT_GIN_AST_MGMT_rnum, DXCT_GIN_AST_MGMT_pnum,DXCT_GIN_AST_MGMT_lid)
)


ALTER TABLE tucson.DXCT_GIN_AST_MGMT
    OWNER TO tucson;
...
CREATE SEQUENCE tucson.DXCT_TRN_AST_START_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_TRN_AST_START_id_seq
    OWNER TO tucson;

						
								
CREATE TABLE tucson.DXCT_TRN_AST_START
(
    ...
    DXCT_TRN_AST_START_id INTEGER DEFAULT NEXTVAL('tucson.DXCT_TRN_AST_START_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_ast_START_pkey PRIMARY KEY (DXCT_TRN_AST_START_GIN)
)

ALTER TABLE tucson.DXCT_TRN_AST_START
    OWNER TO tucson;

---------------------------------------------------------------------------------
			

CREATE SEQUENCE tucson.DXCT_TRN_AST_END_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_TRN_AST_END_id_seq
    OWNER TO tucson;
								
CREATE TABLE tucson.DXCT_TRN_AST_END
(
    ...
    DXCT_TRN_AST_END_id INTEGER DEFAULT NEXTVAL('tucson.DXCT_TRN_AST_END_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_ast_END_pkey PRIMARY KEY (DXCT_TRN_AST_END_GIN)
)

ALTER TABLE tucson.DXCT_TRN_AST_END
    OWNER TO tucson;

---------------------------------------------------------------------------------

CREATE SEQUENCE tucson.DXCT_TRN_STR_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_TRN_STR_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.DXCT_TRN_STR
(
    ...
    DXCT_TRN_STR_id INTEGER DEFAULT NEXTVAL('tucson.DXCT_TRN_STR_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_STR_pkey PRIMARY KEY (DXCT_TRN_STR_GIN)
)

ALTER TABLE tucson.DXCT_TRN_STR
    OWNER TO tucson;

---------------------------------------------------------------------------------


CREATE SEQUENCE tucson.DXCT_TRN_STR_REJ_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_TRN_STR_REJ_id_seq
    OWNER TO tucson;

CREATE TABLE tucson.DXCT_TRN_STR_REJ
(
    ...
    DXCT_TRN_STR_REJ_id INTEGER DEFAULT NEXTVAL('tucson.DXCT_TRN_STR_REJ_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_STOR_REJ_pkey PRIMARY KEY (DXCT_TRN_STR_REJ_GIN)
)

ALTER TABLE tucson.DXCT_TRN_STR_REJ
    OWNER TO tucson;

---------------------------------------------------------------------------------


CREATE SEQUENCE tucson.DXCT_TRN_INSTALL_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE tucson.DXCT_TRN_INSTALL_id_seq
    OWNER TO tucson;

						
								
CREATE TABLE tucson.DXCT_TRN_INSTALL
(
    ...
    DXCT_TRN_INSTALL_id INTEGER DEFAULT NEXTVAL('tucson.DXCT_TRN_INSTALL_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_INSTALL_pkey PRIMARY KEY (DXCT_TRN_INSTALL_GIN)
)

ALTER TABLE tucson.DXCT_TRN_INSTALL
    OWNER TO tucson;

---------------------------------------------------------------------------------

CREATE TABLE tucson.DXCT_SMTP
(
...
CREATE INDEX DXCT_ORG_IDX1 ON TUCSON.DXCT_ORG(dxct_org_id);

CREATE INDEX DXCT_GRP_IDX1 ON TUCSON.DXCT_GRP(dxct_grp_id);

CREATE INDEX DXCT_USR_IDX1 ON TUCSON.DXCT_USR(dxct_usr_id);

CREATE INDEX DXCT_AUD_IDX1 ON TUCSON.DXCT_AUD(dxct_AUD_ID);

CREATE INDEX DXCT_AUD_IDX2 ON TUCSON.DXCT_AUD(dxct_AUD_ID,dxct_AUD_UID);

CREATE INDEX DXCT_AUD_IDX3 ON TUCSON.DXCT_AUD(dxct_AUD_ID,dxct_AUD_UID,dxct_AUD_ts);

CREATE INDEX DXCT_AUD_IDX4 ON TUCSON.DXCT_AUD(dxct_AUD_ts);

CREATE INDEX DXCT_GIN_ACQ_IDX1 ON TUCSON.DXCT_GIN_ACQ (DXCT_GIN_ACQ_RNUM);

CREATE INDEX DXCT_GIN_ACQ_IDX2 ON TUCSON.DXCT_GIN_ACQ (DXCT_GIN_ACQ_PNUM,DXCT_GIN_ACQ_LID);

CREATE INDEX DXCT_GIN_ACQ_IDX3 ON TUCSON.DXCT_GIN_ACQ (DXCT_GIN_ACQ_RNUM, DXCT_GIN_ACQ_PNUM, DXCT_GIN_ACQ_LID);

CREATE INDEX DXCT_GIN_AST_MGMT_IDX1 ON TUCSON.DXCT_GIN_AST_MGMT (DXCT_GIN_AST_MGMT_RNUM, DXCT_GIN_AST_MGMT_PNUM, DXCT_GIN_AST_MGMT_LID);

CREATE INDEX DXCT_GIN_INSTALL_IDX1 ON TUCSON.DXCT_GIN_INSTALL (DXCT_GIN_INSTALL_RNUM, DXCT_GIN_INSTALL_PNUM, DXCT_GIN_INSTALL_LID);

CREATE INDEX DXCT_GIN_OEM_IDX1 ON TUCSON.DXCT_GIN_OEM(DXCT_GIN_OEM_RNUM, DXCT_GIN_OEM_PNUM, DXCT_GIN_OEM_LID);

CREATE INDEX DXCT_GIN_STR_IDX1 ON TUCSON.DXCT_GIN_STR (DXCT_GIN_STR_RNUM, DXCT_GIN_STR_PNUM, DXCT_GIN_STR_LID);
	
CREATE INDEX DXCT_GIN_STR_REJ_IDX1 ON TUCSON.DXCT_GIN_STR_REJ (DXCT_GIN_STR_REJ_RNUM, DXCT_GIN_STR_REJ_PNUM, DXCT_GIN_STR_REJ_LID);	

CREATE INDEX DXCT_GIN_SUPP_MAINT_IDX1 ON TUCSON.DXCT_GIN_SUPP_MAINT (DXCT_GIN_SUPP_MAINT_RNUM, DXCT_GIN_SUPP_MAINT_PNUM, DXCT_GIN_SUPP_MAINT_LID);	

CREATE INDEX DXCT_TRN_STR_IDX1 ON TUCSON.DXCT_TRN_STR (DXCT_TRN_STR_GIN);
	
CREATE INDEX DXCT_TRN_STR_REJ_IDX1 ON TUCSON.DXCT_TRN_STR_REJ (DXCT_TRN_STR_REJ_GIN);

CREATE INDEX DXCT_TRN_INSTALL_IDX1 ON TUCSON.DXCT_TRN_INSTALL (DXCT_TRN_INSTALL_GIN);

CREATE INDEX DXCT_TRN_AST_START_IDX1 ON TUCSON.DXCT_TRN_AST_START (DXCT_TRN_AST_START_GIN);

CREATE INDEX DXCT_TRN_AST_END_IDX1 ON TUCSON.DXCT_TRN_AST_END (DXCT_TRN_AST_END_GIN);

CREATE INDEX DXCT_RACK_IDX1 ON TUCSON.DXCT_RACK (DXCT_RACK_ID);
...
ALTER TABLE TUCSON.DXCT_GRP ADD CONSTRAINT DXCT_GRP_UC1 UNIQUE (DXCT_GRP_ID);

ALTER TABLE TUCSON.DXCT_USR 
ADD CONSTRAINT DXCT_USR_FK1 
FOREIGN KEY (DXCT_USR_GID)
REFERENCES TUCSON.DXCT_GRP (DXCT_GRP_ID);

ALTER TABLE TUCSON.DXCT_ORG ADD CONSTRAINT DXCT_ORG_UC1 UNIQUE (DXCT_ORG_ID);

ALTER TABLE TUCSON.DXCT_USR 
ADD CONSTRAINT DXCT_USR_FK2 
FOREIGN KEY (DXCT_USR_OID)
REFERENCES TUCSON.DXCT_ORG (DXCT_ORG_ID);

ALTER TABLE TUCSON.DXCT_USR ADD CONSTRAINT DXCT_USR_UC1 UNIQUE (DXCT_USR_ID);

ALTER TABLE TUCSON.DXCT_AUD 
ADD CONSTRAINT DXCT_AUD_FK1 
FOREIGN KEY (DXCT_AUD_UID)
REFERENCES TUCSON.DXCT_USR (DXCT_USR_ID);

ALTER TABLE TUCSON.DXCT_AUD ADD CONSTRAINT DXCT_AUD_UC1 UNIQUE (DXCT_AUD_ID);


ALTER TABLE TUCSON.DXCT_USR_TYPE ADD CONSTRAINT DXCT_USR_TYPE_UC1 UNIQUE (DXCT_USR_TYPE_ID);

ALTER TABLE TUCSON.DXCT_USR 
ADD CONSTRAINT DXCT_USR_FK3 
FOREIGN KEY (DXCT_USR_TYPE)
REFERENCES TUCSON.DXCT_USR_TYPE (DXCT_USR_TYPE_ID);
...
REFERENCES TUCSON.DXCT_GIN_ACQ (DXCT_GIN_ACQ_RNUM,DXCT_GIN_ACQ_PNUM,DXCT_GIN_ACQ_LID);
...
ALTER TABLE TUCSON.DXCT_TRN_AST_START ADD CONSTRAINT DXCT_TRN_AST_START_UC1 UNIQUE (DXCT_TRN_AST_START_GIN);

ALTER TABLE TUCSON.DXCT_TRN_AST_END 
ADD CONSTRAINT DXCT_TRN_AST_END_FK1 
FOREIGN KEY (DXCT_TRN_AST_END_GIN)
REFERENCES TUCSON.DXCT_TRN_AST_START (DXCT_TRN_AST_START_GIN);
...
ALTER TABLE TUCSON.DXCT_RACK ADD CONSTRAINT DXCT_RACK_UC2 UNIQUE (DXCT_RACK_NAME);

ALTER TABLE TUCSON.DXCT_TRN_INSTALL
ADD CONSTRAINT DXCT_TRN_INSTALL_FK2 
FOREIGN KEY (DXCT_TRN_INSTALL_RACK_LOC)
REFERENCES TUCSON.DXCT_RACK (DXCT_RACK_NAME);	
