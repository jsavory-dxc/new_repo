...
CREATE SCHEMA TUCSON_TEST
    AUTHORIZATION TUCSON_TEST;
...
CREATE SEQUENCE TUCSON_TEST.dxct_grp_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_grp_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.dxct_grp
(
    dxct_grp_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_grp_id_seq') NOT NULL,
...
ALTER TABLE TUCSON_TEST.dxct_grp
    OWNER TO TUCSON_TEST;

------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.dxct_org_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_org_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.DXCT_ORG
(
DXCT_ORG_ID	INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_org_id_seq') NOT NULL,
...
ALTER TABLE TUCSON_TEST.DXCT_ORG
    OWNER TO TUCSON_TEST;

------------------------------------------------------------------------------
CREATE SEQUENCE TUCSON_TEST.dxct_aud_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_aud_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.DXCT_AUD
(
DXCT_AUD_ID	INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_org_id_seq') NOT NULL,
...
ALTER TABLE TUCSON_TEST.dxct_aud
    OWNER TO TUCSON_TEST;

------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.dxct_usr_type_id_seq
    INCREMENT 1
    START 1;
	
ALTER SEQUENCE TUCSON_TEST.dxct_usr_type_id_seq
    OWNER TO TUCSON_TEST;
	
CREATE TABLE TUCSON_TEST.dxct_usr_type
(
    dxct_usr_type_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_usr_type_id_seq') NOT NULL,
...
ALTER TABLE TUCSON_TEST.dxct_usr_type
    OWNER TO TUCSON_TEST;
	
------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.dxct_rack_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_rack_id_seq
    OWNER TO TUCSON_TEST;
	
CREATE TABLE TUCSON_TEST.dxct_rack
(
    dxct_rack_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_rack_id_seq') NOT NULL,
...
ALTER TABLE TUCSON_TEST.dxct_rack
    OWNER TO TUCSON_TEST;
------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.dxct_usr_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_usr_id_seq
    OWNER TO TUCSON_TEST;


CREATE TABLE TUCSON_TEST.dxct_usr
(
    dxct_usr_id integer NOT NULL DEFAULT nextval('TUCSON_TEST.dxct_usr_id_seq'),
...
ALTER TABLE TUCSON_TEST.dxct_usr
    OWNER to TUCSON_TEST;
------------------------------------------------------------------------------

DROP SEQUENCE TUCSON_TEST.dxct_rack_id_seq;
...
DROP TABLE TUCSON_TEST.DXCT_RACK;

CREATE TABLE TUCSON_TEST.DXCT_RACK
(
    dxct_rack_id integer NOT NULL DEFAULT nextval('TUCSON_TEST.dxct_rack_id_seq'),
    dxct_rack_name varchar(30) NOT NULL,
    dxct_rack_desc varchar(100) NOT NULL,
    CONSTRAINT dxct_rack_pkey PRIMARY KEY (dxct_rack_id, dxct_rack_name)
)

ALTER TABLE TUCSON_TEST.DXCT_RACK ADD CONSTRAINT DXCT_RACK_UC1 UNIQUE (DXCT_RACK_ID);
...
CREATE SEQUENCE TUCSON_TEST.dxct_gin_acq_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_gin_acq_id_seq
    OWNER TO TUCSON_TEST;

								
CREATE TABLE TUCSON_TEST.dxct_gin_acq
(
    ...
    dxct_gin_acq_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_gin_acq_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_acq_pkey PRIMARY KEY (dxct_gin_acq_lid, dxct_gin_acq_rnum)
)


ALTER TABLE TUCSON_TEST.DXCT_GIN_ACQ
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.dxct_gin_str_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_gin_str_id_seq
    OWNER TO TUCSON_TEST;

								
CREATE TABLE TUCSON_TEST.dxct_gin_str
(
	...
	DXCT_GIN_STR_ID INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_gin_str_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_str_pkey PRIMARY KEY (DXCT_GIN_STR_rnum, DXCT_GIN_STR_pnum,DXCT_GIN_STR_lid)
)


ALTER TABLE TUCSON_TEST.DXCT_GIN_STR
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.dxct_gin_str_rej_id_seq
    INCREMENT 1
    START 1;

ALTER SEQUENCE TUCSON_TEST.dxct_gin_str_rej_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.dxct_gin_str_REJ
(
	...
	DXCT_GIN_STR_REJ_ID INTEGER DEFAULT NEXTVAL('TUCSON_TEST.dxct_gin_str_rej_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_str_rej_pkey PRIMARY KEY (DXCT_GIN_STR_REJ_rnum, DXCT_GIN_STR_REJ_pnum,DXCT_GIN_STR_REJ_lid)
)

ALTER TABLE TUCSON_TEST.DXCT_GIN_STR_REJ
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------


CREATE SEQUENCE TUCSON_TEST.DXCT_GIN_INSTALL_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
...
ALTER SEQUENCE TUCSON_TEST.DXCT_GIN_INSTALL_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.DXCT_GIN_INSTALL
(
	...
	DXCT_GIN_INSTALL_ID INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_GIN_INSTALL_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_install_pkey PRIMARY KEY (DXCT_GIN_INSTALL_rnum, DXCT_GIN_INSTALL_pnum,DXCT_GIN_INSTALL_lid)
)

ALTER TABLE TUCSON_TEST.DXCT_GIN_INSTALL
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------


CREATE SEQUENCE TUCSON_TEST.DXCT_GIN_OEM_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_GIN_OEM_id_seq
    OWNER TO TUCSON_TEST;
    
CREATE TABLE TUCSON_TEST.DXCT_GIN_OEM
(
	...
	DXCT_GIN_OEM_ID INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_GIN_OEM_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_oem_pkey PRIMARY KEY (DXCT_GIN_OEM_rnum, DXCT_GIN_OEM_pnum,DXCT_GIN_OEM_lid)
)


ALTER TABLE TUCSON_TEST.DXCT_GIN_OEM
    OWNER TO TUCSON_TEST;
...
CREATE SEQUENCE TUCSON_TEST.DXCT_GIN_SUPP_MAINT_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_GIN_SUPP_MAINT_id_seq
    OWNER TO TUCSON_TEST;
    
CREATE TABLE TUCSON_TEST.DXCT_GIN_SUPP_MAINT
(
	...
	DXCT_GIN_SUPP_MAINT_ID INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_GIN_SUPP_MAINT_id_seq') NOT NULL,
...
ALTER TABLE TUCSON_TEST.DXCT_GIN_SUPP_MAINT
    OWNER TO TUCSON_TEST;


---------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.DXCT_GIN_AST_MGMT_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_GIN_AST_MGMT_id_seq
    OWNER TO TUCSON_TEST;
    
CREATE TABLE TUCSON_TEST.DXCT_GIN_AST_MGMT
(
	...
	DXCT_GIN_AST_MGMT_ID INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_GIN_AST_MGMT_id_seq') NOT NULL,
    CONSTRAINT dxct_gin_ast_mgmt_pkey PRIMARY KEY (DXCT_GIN_AST_MGMT_rnum, DXCT_GIN_AST_MGMT_pnum,DXCT_GIN_AST_MGMT_lid)
)


ALTER TABLE TUCSON_TEST.DXCT_GIN_AST_MGMT
    OWNER TO TUCSON_TEST;
...
CREATE SEQUENCE TUCSON_TEST.DXCT_TRN_AST_START_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_TRN_AST_START_id_seq
    OWNER TO TUCSON_TEST;

						
								
CREATE TABLE TUCSON_TEST.DXCT_TRN_AST_START
(
    ...
    DXCT_TRN_AST_START_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_TRN_AST_START_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_ast_START_pkey PRIMARY KEY (DXCT_TRN_AST_START_GIN)
)

ALTER TABLE TUCSON_TEST.DXCT_TRN_AST_START
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------
			

CREATE SEQUENCE TUCSON_TEST.DXCT_TRN_AST_END_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_TRN_AST_END_id_seq
    OWNER TO TUCSON_TEST;
								
CREATE TABLE TUCSON_TEST.DXCT_TRN_AST_END
(
    ...
    DXCT_TRN_AST_END_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_TRN_AST_END_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_ast_END_pkey PRIMARY KEY (DXCT_TRN_AST_END_GIN)
)

ALTER TABLE TUCSON_TEST.DXCT_TRN_AST_END
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------

CREATE SEQUENCE TUCSON_TEST.DXCT_TRN_STR_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_TRN_STR_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.DXCT_TRN_STR
(
    ...
    DXCT_TRN_STR_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_TRN_STR_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_STR_pkey PRIMARY KEY (DXCT_TRN_STR_GIN)
)

ALTER TABLE TUCSON_TEST.DXCT_TRN_STR
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------


CREATE SEQUENCE TUCSON_TEST.DXCT_TRN_STR_REJ_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_TRN_STR_REJ_id_seq
    OWNER TO TUCSON_TEST;

CREATE TABLE TUCSON_TEST.DXCT_TRN_STR_REJ
(
    ...
    DXCT_TRN_STR_REJ_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_TRN_STR_REJ_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_STOR_REJ_pkey PRIMARY KEY (DXCT_TRN_STR_REJ_GIN)
)

ALTER TABLE TUCSON_TEST.DXCT_TRN_STR_REJ
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------


CREATE SEQUENCE TUCSON_TEST.DXCT_TRN_INSTALL_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE TUCSON_TEST.DXCT_TRN_INSTALL_id_seq
    OWNER TO TUCSON_TEST;

						
								
CREATE TABLE TUCSON_TEST.DXCT_TRN_INSTALL
(
    ...
    DXCT_TRN_INSTALL_id INTEGER DEFAULT NEXTVAL('TUCSON_TEST.DXCT_TRN_INSTALL_id_seq') NOT NULL,
    CONSTRAINT dxct_trn_INSTALL_pkey PRIMARY KEY (DXCT_TRN_INSTALL_GIN)
)

ALTER TABLE TUCSON_TEST.DXCT_TRN_INSTALL
    OWNER TO TUCSON_TEST;

---------------------------------------------------------------------------------

CREATE TABLE TUCSON_TEST.DXCT_SMTP
(
...
ALTER TABLE TUCSON_TEST.DXCT_SMTP
    OWNER TO TUCSON_TEST;
...
CREATE INDEX DXCT_ORG_IDX1 ON TUCSON_TEST.DXCT_ORG(dxct_org_id);

CREATE INDEX DXCT_GRP_IDX1 ON TUCSON_TEST.DXCT_GRP(dxct_grp_id);

CREATE INDEX DXCT_USR_IDX1 ON TUCSON_TEST.DXCT_USR(dxct_usr_id);

CREATE INDEX DXCT_AUD_IDX1 ON TUCSON_TEST.DXCT_AUD(dxct_AUD_ID);

CREATE INDEX DXCT_AUD_IDX2 ON TUCSON_TEST.DXCT_AUD(dxct_AUD_ID,dxct_AUD_UID);

CREATE INDEX DXCT_AUD_IDX3 ON TUCSON_TEST.DXCT_AUD(dxct_AUD_ID,dxct_AUD_UID,dxct_AUD_ts);

CREATE INDEX DXCT_AUD_IDX4 ON TUCSON_TEST.DXCT_AUD(dxct_AUD_ts);

CREATE INDEX DXCT_GIN_ACQ_IDX1 ON TUCSON_TEST.DXCT_GIN_ACQ (DXCT_GIN_ACQ_RNUM);

CREATE INDEX DXCT_GIN_ACQ_IDX2 ON TUCSON_TEST.DXCT_GIN_ACQ (DXCT_GIN_ACQ_PNUM,DXCT_GIN_ACQ_LID);

CREATE INDEX DXCT_GIN_ACQ_IDX3 ON TUCSON_TEST.DXCT_GIN_ACQ (DXCT_GIN_ACQ_RNUM, DXCT_GIN_ACQ_PNUM, DXCT_GIN_ACQ_LID);

CREATE INDEX DXCT_GIN_AST_MGMT_IDX1 ON TUCSON_TEST.DXCT_GIN_AST_MGMT (DXCT_GIN_AST_MGMT_RNUM, DXCT_GIN_AST_MGMT_PNUM, DXCT_GIN_AST_MGMT_LID);

CREATE INDEX DXCT_GIN_INSTALL_IDX1 ON TUCSON_TEST.DXCT_GIN_INSTALL (DXCT_GIN_INSTALL_RNUM, DXCT_GIN_INSTALL_PNUM, DXCT_GIN_INSTALL_LID);

CREATE INDEX DXCT_GIN_OEM_IDX1 ON TUCSON_TEST.DXCT_GIN_OEM(DXCT_GIN_OEM_RNUM, DXCT_GIN_OEM_PNUM, DXCT_GIN_OEM_LID);

CREATE INDEX DXCT_GIN_STR_IDX1 ON TUCSON_TEST.DXCT_GIN_STR (DXCT_GIN_STR_RNUM, DXCT_GIN_STR_PNUM, DXCT_GIN_STR_LID);
	
CREATE INDEX DXCT_GIN_STR_REJ_IDX1 ON TUCSON_TEST.DXCT_GIN_STR_REJ (DXCT_GIN_STR_REJ_RNUM, DXCT_GIN_STR_REJ_PNUM, DXCT_GIN_STR_REJ_LID);	

CREATE INDEX DXCT_GIN_SUPP_MAINT_IDX1 ON TUCSON_TEST.DXCT_GIN_SUPP_MAINT (DXCT_GIN_SUPP_MAINT_RNUM, DXCT_GIN_SUPP_MAINT_PNUM, DXCT_GIN_SUPP_MAINT_LID);	

CREATE INDEX DXCT_TRN_STR_IDX1 ON TUCSON_TEST.DXCT_TRN_STR (DXCT_TRN_STR_GIN);
	
CREATE INDEX DXCT_TRN_STR_REJ_IDX1 ON TUCSON_TEST.DXCT_TRN_STR_REJ (DXCT_TRN_STR_REJ_GIN);

CREATE INDEX DXCT_TRN_INSTALL_IDX1 ON TUCSON_TEST.DXCT_TRN_INSTALL (DXCT_TRN_INSTALL_GIN);

CREATE INDEX DXCT_TRN_AST_START_IDX1 ON TUCSON_TEST.DXCT_TRN_AST_START (DXCT_TRN_AST_START_GIN);

CREATE INDEX DXCT_TRN_AST_END_IDX1 ON TUCSON_TEST.DXCT_TRN_AST_END (DXCT_TRN_AST_END_GIN);

CREATE INDEX DXCT_RACK_IDX1 ON TUCSON_TEST.DXCT_RACK (DXCT_RACK_ID);

=======================================================
	REFERENTIAL INTEGRITY CONSTRAINTS
=======================================================

ALTER TABLE TUCSON_TEST.DXCT_GRP ADD CONSTRAINT DXCT_GRP_UC1 UNIQUE (DXCT_GRP_ID);

ALTER TABLE TUCSON_TEST.DXCT_USR 
ADD CONSTRAINT DXCT_USR_FK1 
FOREIGN KEY (DXCT_USR_GID)
REFERENCES TUCSON_TEST.DXCT_GRP (DXCT_GRP_ID);

ALTER TABLE TUCSON_TEST.DXCT_ORG ADD CONSTRAINT DXCT_ORG_UC1 UNIQUE (DXCT_ORG_ID);

ALTER TABLE TUCSON_TEST.DXCT_USR 
ADD CONSTRAINT DXCT_USR_FK2 
FOREIGN KEY (DXCT_USR_OID)
REFERENCES TUCSON_TEST.DXCT_ORG (DXCT_ORG_ID);

ALTER TABLE TUCSON_TEST.DXCT_USR ADD CONSTRAINT DXCT_USR_UC1 UNIQUE (DXCT_USR_ID);

ALTER TABLE TUCSON_TEST.DXCT_AUD 
ADD CONSTRAINT DXCT_AUD_FK1 
FOREIGN KEY (DXCT_AUD_UID)
REFERENCES TUCSON_TEST.DXCT_USR (DXCT_USR_ID);

ALTER TABLE TUCSON_TEST.DXCT_AUD ADD CONSTRAINT DXCT_AUD_UC1 UNIQUE (DXCT_AUD_ID);

ALTER TABLE TUCSON_TEST.DXCT_USR_TYPE ADD CONSTRAINT DXCT_USR_TYPE_UC1 UNIQUE (DXCT_USR_TYPE_ID);

ALTER TABLE TUCSON_TEST.DXCT_USR 
ADD CONSTRAINT DXCT_USR_FK3 
FOREIGN KEY (DXCT_USR_TYPE)
REFERENCES TUCSON_TEST.DXCT_USR_TYPE (DXCT_USR_TYPE_ID);
...
REFERENCES TUCSON_TEST.DXCT_GIN_ACQ (DXCT_GIN_ACQ_RNUM,DXCT_GIN_ACQ_PNUM,DXCT_GIN_ACQ_LID);
...
ALTER TABLE TUCSON_TEST.DXCT_TRN_AST_START ADD CONSTRAINT DXCT_TRN_AST_START_UC1 UNIQUE (DXCT_TRN_AST_START_GIN);

ALTER TABLE TUCSON_TEST.DXCT_TRN_AST_END 
ADD CONSTRAINT DXCT_TRN_AST_END_FK1 
FOREIGN KEY (DXCT_TRN_AST_END_GIN)
REFERENCES TUCSON_TEST.DXCT_TRN_AST_START (DXCT_TRN_AST_START_GIN);
...
ALTER TABLE TUCSON_TEST.DXCT_RACK ADD CONSTRAINT DXCT_RACK_UC2 UNIQUE (DXCT_RACK_NAME);

ALTER TABLE TUCSON_TEST.DXCT_TRN_INSTALL
ADD CONSTRAINT DXCT_TRN_INSTALL_FK2 
FOREIGN KEY (DXCT_TRN_INSTALL_RACK_LOC)
REFERENCES TUCSON_TEST.DXCT_RACK (DXCT_RACK_NAME);
